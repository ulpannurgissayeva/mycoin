...
import 'side_bar_nav3_model.dart';
export 'side_bar_nav3_model.dart';

class SideBarNav3Widget extends StatefulWidget {
  const SideBarNav3Widget({
    super.key,
    this.oneBG,
    this.oneIcon,
    this.twoBG,
  ...
  @override
  State<SideBarNav3Widget> createState() => _SideBarNav3WidgetState();
}

class _SideBarNav3WidgetState extends State<SideBarNav3Widget> {
  late SideBarNav3Model _model;
  double _balance = 0.0;
  String _publicKey = "";
  ...
  void initState() {
    super.initState();
    _loadBalance();
    _model = createModel(context, () => SideBarNav3Model());
  }
