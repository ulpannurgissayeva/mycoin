...
import 'side_bar_nav5_model.dart';
export 'side_bar_nav5_model.dart';

class SideBarNav5Widget extends StatefulWidget {
  const SideBarNav5Widget({
    super.key,
    this.oneBG,
    this.oneIcon,
    this.twoBG,
  ...
  @override
  State<SideBarNav5Widget> createState() => _SideBarNav5WidgetState();
}

class _SideBarNav5WidgetState extends State<SideBarNav5Widget> {
  late SideBarNav5Model _model;
  double _balance = 0.0;
  String _publicKey = "";
  ...
  void initState() {
    super.initState();
    _loadBalance();
    _model = createModel(context, () => SideBarNav5Model());
  }
