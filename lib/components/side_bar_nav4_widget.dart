...
import 'side_bar_nav4_model.dart';
export 'side_bar_nav4_model.dart';

class SideBarNav4Widget extends StatefulWidget {
  const SideBarNav4Widget({
    super.key,
    this.oneBG,
    this.oneIcon,
    this.twoBG,
  ...
  @override
  State<SideBarNav4Widget> createState() => _SideBarNav4WidgetState();
}

class _SideBarNav4WidgetState extends State<SideBarNav4Widget> {
  late SideBarNav4Model _model;
  double _balance = 0.0;
  String _publicKey = "";
  ...
  void initState() {
    super.initState();
    _loadBalance();
    _model = createModel(context, () => SideBarNav4Model());
  }
