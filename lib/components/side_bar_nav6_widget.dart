...
import 'side_bar_nav6_model.dart';
export 'side_bar_nav6_model.dart';

class SideBarNav6Widget extends StatefulWidget {
  const SideBarNav6Widget({
    super.key,
    this.oneBG,
    this.oneIcon,
    this.twoBG,
  ...
  @override
  State<SideBarNav6Widget> createState() => _SideBarNav6WidgetState();
}

class _SideBarNav6WidgetState extends State<SideBarNav6Widget> {
  late SideBarNav6Model _model;
  double _balance = 0.0;
  String _publicKey = "";
  ...
  void initState() {
    super.initState();
    _loadBalance();
    _model = createModel(context, () => SideBarNav6Model());
  }
